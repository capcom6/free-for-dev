...
## Messaging and Streaming
  ...
  * [SMSGate](https://sms-gate.app) - SMS Gateway for Android™ is an open-source app that enables sending and receiving SMS messages through your devices using either direct device access or cloud routing. Free to use with unlimited messages via local or self-hosted private server, and completely free cloud service (with recommended notification for usage above 10,000 messages/day to maintain quality for all users).
